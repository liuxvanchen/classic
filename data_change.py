...
if time_len % 12 != 0:
    ...
    # # 计算每年的全球平均气温
    # global_avg_t2m_celsius = np.mean(annual_avg_t2m_celsius, axis=(1, 2))
    #
    # years = np.arange(1982, 2021)
    #
    # plt.figure(figsize=(14, 7))
    # plt.plot(years, global_avg_t2m_celsius, label='Temperature', marker='o')
    ...
    #
    # # 降水
    # global_avg_tp = np.mean(annual_avg_tp, axis=(1, 2))
    # years = np.arange(1982, 2021)
    #
    # plt.figure(figsize=(14, 7))
    # plt.plot(years, global_avg_tp, label='precipitation', marker='s')
    ...
    # plt.show()
    #
    # global_avg_ssrd = np.mean(annual_avg_ssrd, axis=(1, 2))
    # years = np.arange(1982, 2021)
    #
    # # 辐射
    # plt.figure(figsize=(14, 7))
    # plt.plot(years, global_avg_ssrd, label='Radiation', marker='^')
